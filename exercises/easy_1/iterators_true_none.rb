...
# In this exercise, you will develop another of the methods in this family,
# none?.
...
# returns true for any element, then #none? returns false. Otherwise, #none?
# returns true. Note in particular that #none? will stop searching the
